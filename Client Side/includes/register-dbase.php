...
if (isset($_POST['submit'])){
	...
	if(empty($first_name) || empty($last_name) || empty($username) ||  empty($age) || empty($email) || empty($password)){
		...
		exit();
			...
			if ($resultcheck > 0){
				...
				$query = "INSERT INTO client (first_name, last_name, username, age, email, password) VALUES ('$first_name', '$last_name', '$username',  '$age', '$email', '$hashedPwd')";

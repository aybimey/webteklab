        ...
        <button class="btn btn-secondary" type="submit" name="submit"><i class="fa fa-hand-o-right" aria-hidden="true"></i> Go</button> 
              ...
              <div class="row">
                 <div class="col-lg-6">
                     ...
                     <div class="col-lg-5"><input class="form-control" type="number" class="form-control" name="max" value="max"></div>
                     <div class="col"><button class="btn btn-secondary" type="number" name="submit"><i class="fa fa-hand-o-right"></i> Go</button> 
                         </div>
        ...
        <div class="row">
             ...
             <% 
                ...
                try{
                    ...
                    String sql = "SELECT * from collection where shop_name='"+session.getAttribute( "shop_name" )+"' and category_name='"+category_name+"' order by collection_id DESC" ;

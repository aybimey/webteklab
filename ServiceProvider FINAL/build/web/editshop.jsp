...
<body>
  ...
  <div id="journal-blog" class="text-left  paddsections" style="margin-top:5%;">
   ...
   <div class="container">
        <form class="form-group" method="post" action="editshop-process.jsp">
          
        <input type="hidden" name="shop_id" value="<%=rs.getString("shop_id") %>">
        
        <strong>Shop Information:</strong><br>
        <input class="form-control" type="text" name="shop_info" value="<%=rs.getString("shop_info") %>" style="background-color:#F1D6B8;">
        <br>
        <strong>Shop Address:</strong><br>
        <input class="form-control" type="text" name="address" value="<%=rs.getString("address") %>" style="background-color:#F1D6B8;">
        <br>
        <strong>Shop Contact:</strong><br>
        <input class="form-control" type="text" name="shop_contact" value="<%=rs.getString("shop_contact") %>" style="background-color:#F1D6B8;">
        <br>
        <div class="modal-footer">
        <input type="submit" class="btn btn-secondary" value="Save">
        <a href="home.jsp?id= <%=rs.getString("shop_id") %>" class="btn btn-secondary" style="padding-top:1%; background-color:red;"><i class="fa fa-window-close" aria-hidden="true"></i> Cancel </a>
        </div>

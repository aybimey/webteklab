        ...
        <div class="col-lg-7">
		  ...
		  <h5 style="font-family: 'Raleway', sans-serif; font-size: 19px; font-weight: bold;">Rent Now</h5>
			...
			<label style="font-family: 'Raleway', sans-serif; font-size: 18px;">When will you reserve this?</label>
                <input type="date" min="<?php echo date('Y-m-d'); ?>" name="req_datereserved" value="<?php echo date('Y-m-d'); ?>">
                <br>
			<label style="font-family: 'Raleway', sans-serif; font-size: 18px;">Enter Quantity: </label>
                        <input type="number" min="1" max="<?php echo $rent['collection_quantity'];?>" id="arrive" class="floatLabel" name="req_quantity" placeholder="<?php echo $rent['collection_quantity'];?> quantities available" style="width:200px;" >
			<br><br>
